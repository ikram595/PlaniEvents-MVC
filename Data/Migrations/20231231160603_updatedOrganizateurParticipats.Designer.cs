...
namespace PlaniEvents123.Data.Migrations
{
    ...
    [Migration("20231231160603_updatedOrganizateurParticipats")]
    partial class updatedOrganizateurParticipats
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlaniEvents123.Models.Event", b =>
                {
                    ...
                    b.Property<string>("OrganisateurEmail")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PlaniEvents123.Models.Event", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "Organisateur")
                        .WithMany()
